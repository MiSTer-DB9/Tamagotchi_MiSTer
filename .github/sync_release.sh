...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Tamagotchi_MiSTer.git"
CORE_NAME=(Tamagotchi)
...
UPSTREAM_CORE_NAME=(Tamagotchi)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Tamagotchi.qpf)
COMPILATION_OUTPUT=(output_files/Tamagotchi.rbf)
